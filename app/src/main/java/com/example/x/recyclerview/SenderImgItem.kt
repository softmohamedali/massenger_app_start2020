...
class SenderImgItem(var massge:ImgSender,var context:Context,chatChannelId:String):Item() {
    ...
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        Glide.with(context)
            ...
            .into(viewHolder.img_masg_senderlayout)

    }

    override fun getLayout(): Int {
        return R.layout.sender_img_itm
    }
}